...
# _FLASK_PORT, _RUN_ID_RE, _LOOPBACK_HOSTS, _TRUTHY_BYPASS → helpers/security.py (Unit 3)
from .security import _FLASK_PORT, _LOOPBACK_HOSTS, _TRUTHY_BYPASS, _ensure_csrf_token, _oauth_callback_uri  # noqa: E402 (needed by __init__ code)
...
# _parse_publish_results, _HISTORY_MAX_ITEMS, _push_history_per_row,
# _push_history_single_failure, _apply_history_cap, _REQUIRES_URL_STATUSES,
# _push_history_aggregate → moved to helpers/history.py (Plan 2026-05-21-007 Unit 2)

# Re-import for __init__-level code that still references _push_history_aggregate.
from .history import _push_history_aggregate  # noqa: E402
...
# _check_localhost, _FLASH_MSG_MAX_LEN, _safe_flash_redirect, _safe_referrer_redirect,
# _validate_webui_run_id, _oauth_callback_uri, _resolve_bind_host, _ensure_csrf_token,
# _check_csrf_or_abort, _check_bind_origin_or_abort, _refuse_when_allow_network
