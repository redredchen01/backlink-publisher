...
def block_real_network(monkeypatch):
    ...
    monkeypatch.setattr("backlink_publisher.publishing.adapters.llm_anchor_provider.http_post", _never)
...
def test_generate_candidates_returns_list(monkeypatch):
    ...
    monkeypatch.setattr(
        "backlink_publisher.publishing.adapters.llm_anchor_provider.http_post", fake_post,
    )
